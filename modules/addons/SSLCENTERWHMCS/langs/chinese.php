...
$_LANG['addonAA']['apiConfiguration']['item']['default_csr_generator_country']['description']          = '默认选项';
...
$_LANG['addonAA']['apiConfiguration']['item']['summary_expires_soon_days']['label']                    = '即将过期';
...
$_LANG['addonAA']['apiConfiguration']['item']['custom_guide']['label']                  = '客户指南（产品页面）';
...
$_LANG['addonAA']['productsConfiguration']['customguide']         = '自定义设置：';
...
$_LANG['addonAA']['productsConfiguration']['autoSetup']           = '自动开通：';
...
$_LANG['addonAA']['productsConfiguration']['doNotAnything']       = '放弃';
...
$_LANG['addonAA']['productsCreator']['saveSingle']      = '创建单个产品';

$_LANG['addonAA']['productsCreator']['multipleProductCreator'] = '创建多个产品';
$_LANG['addonAA']['productsCreator']['saveMultiple']           = '创建单个产品';
